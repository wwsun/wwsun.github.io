...
SKills 是一组指令，用来教 Claude 如何完成某项任务。你只需在一个文档中解释一次，就像培训手册一样，然后交给 Claude。下次你让 Claude 做这件事时，它会查阅这个文档，阅读指令，然后完成任务。详细的高级指南可以参考官方发布的 [[building-skills-for-claude|构建 Claude 技能完整指南]]。
...
在 AI 辅助编码中，技能可以通过良好的交互设计（如停顿、去脚手架）来为学习者提供适度的认知支持。关于如何通过技能克服被动学习与流畅性幻觉的底层原理，可以查阅 [[ai-coding-learning-science-principles|AI 辅助编码中的学习科学原理]]。
