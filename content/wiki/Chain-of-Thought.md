...
- **必读论文**：_Large Language Models are Zero-Shot Reasoners_ (Kojima et al., 2022)。
...
- **必读论文**：_Self-Consistency Improves Chain of Thought Reasoning in Language Models_ (Wang et al., 2022).
...
- **必读论文**：_Tree of Thoughts: Deliberate Problem Solving with Large Language Models_ (Yao et al., 2023).
- **图示理解**：
