...
4. Choose emojis that match the context and tone Return only the emojified text.
...
3. Break down complex concepts Return only the simplified explanation.
...
3. Maintaining the original tone and style Return only the expanded text.
...
2. Essential details
3. Original tone and style Return only the shortened text.
...
3. Maintain the core message Return only the tweet text.

# Rewrite as tweets thread
...
3. Keep formatting and structure Return only the translated text.